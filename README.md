...
**GitHub Pages:** o workflow em `.github/workflows/deploy.yml` publica automaticamente a cada push na branch `main`. URL do site: [https://pachicodes.github.io/Leitora-do-Mundo/](https://pachicodes.github.io/Leitora-do-Mundo/). Em **Settings → Pages**, a origem deve ser **GitHub Actions** (não “Deploy from a branch”).
